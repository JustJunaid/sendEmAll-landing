...
form:
  emailSubject: "New form submission from SendEmAll website" # Customized email subject (applicable when anyone submit form, form submission may receive by email depend on provider)
  submitButton:
    label: "Submit"
  ...
  inputs:
    ...
    - note: warning # info | warning | success | deprecated | hint
      ...
      content: Something went wrong! please use this mail - [hello@sendemall.com](mailto:hello@sendemall.com) to submit a ticket!
