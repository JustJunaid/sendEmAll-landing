...
excerpt: "Everything you need to set up cold email infrastructure from scratch: domain strategy, Google Workspace configuration, DNS authentication, warmup, mailbox rotation, and sending limits. Detailed enough to follow without any tool."
---
...
You upload your potential buyers (or let our [signal-qualified lead discovery](/services/apollo-scraper) find them). You write your message (or let our [AI personalization](/products/cold-email) write it). SendEmAll handles everything between "potential buyer identified" and "reply received."

This infrastructure is provisioned on demand: mailboxes from $1.50/mo each (Google Workspace and Microsoft 365 from $3.50), domains at registrar cost, DNS and warmup handled automatically. See [pricing details](/pricing).
...
If you'd rather skip the 15-20 hours of setup and the ongoing maintenance, [start with SendEmAll](https://app.sendemall.com/register). Infrastructure is provisioned for you from day one.

Either way, the infrastructure matters. Don't skip it.

[Create your account — infrastructure included →](https://app.sendemall.com/register)
