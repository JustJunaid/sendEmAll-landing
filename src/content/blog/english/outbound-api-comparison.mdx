...
- [Email verification](/solutions/email-verification) is an API call, not a separate tool
...
[Start building with SendEmAll's API](https://app.sendemall.com/signup) — sandbox access and API key available immediately.
