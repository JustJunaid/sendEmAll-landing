...
excerpt: "You have $0 marketing budget and need customers. Here's the realistic path from your first small campaign to your first 10 paying customers using cold email."
---
...
## Start small: your first 25 verified leads

[Create your SendEmAll account](https://app.sendemall.com/register) and you only pay for results: 1 credit = 1 verified, valid email delivered. Scraping, finding, and verification are free — you're never charged for bounces.

Twenty-five doesn't sound like a lot. It's enough.

Here's why: your first 25 emails aren't about closing deals. They're about testing whether your ICP definition and messaging resonate. You're buying information, not pipeline.

**What to do with your first batch:**
1. Define the tightest possible ICP (see below)
2. Let SendEmAll discover and verify 25 potential buyers matching your signals
3. Review and personalize the emails
4. Send them
5. Track which messages get replies and what those replies say

If 0 out of 25 reply: your ICP or messaging is wrong. Adjust and try again.
If 2-3 reply: you've found something. Time to invest more.
If 5+ reply: you've struck a nerve. Scale immediately.
...
## The budget path: first campaign to first 10 customers

### Month 0: Starter ($59/mo)
- 25,000 verified-email credits — start with a batch of 25, you only pay for valid emails
...
### Month 1-2: Starter in earnest ($59/mo + mailboxes)
- Contact ~200 potential buyers/month — a fraction of your monthly credits
- [Sending infrastructure](/mailboxes) from $1.50/mailbox/mo (domains, mailboxes, warmup handled)
...
### Month 3-4: Scale volume (Growth, $79/mo)
- If Starter is working: stay at $59/mo — you're getting customers for well under $100 each
- If you need more volume: [Growth at $79/mo](/pricing) doubles your credits and adds more mailboxes for higher daily sends
- Goal: reach 10 paying customers total
- Expected outcome at ~650 contacts/month: 30-50 replies → 15-25 meetings → 5-10 new customers

### Total investment to reach 10 customers: $300-450
...
The path from zero to 10 customers through outbound is real. It's not fast — expect 3-4 months. It's not easy — you'll rewrite your messaging multiple times. But at under $200/mo, it's the most capital-efficient customer acquisition channel available to a startup.

[Create your account](https://app.sendemall.com/register). Test your ICP today.
