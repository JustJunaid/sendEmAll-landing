...
**Mistake 4: Automating everything before validating the message.** Send the first 50 manually-reviewed emails. Read every reply. Understand what resonates. Then let [AI personalization](/leads) scale what works.
