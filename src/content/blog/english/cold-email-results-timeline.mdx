...
## Week 1-3: Infrastructure and Smart Ramp-Up
...
- [Smart Ramp-Up](/blog/smart-ramp-up-explained) begins: 5-10 emails per mailbox per day
...
**Results:** 2-8 replies (mostly from the Smart Ramp-Up sends). Don't read too much into these — the sample size is too small to be meaningful.
...
- Weeks 1-3: Infrastructure + Smart Ramp-Up (necessary setup time)
...
**Existing domain history.** If you have aged domains (3+ months with clean history), Smart Ramp-Up takes 7-10 days instead of 14-21. That's a week saved.
...
**New domains with zero history.** Full Smart Ramp-Up takes 14-21 days. Add a week if the domain is less than 2 weeks old.
