...
Volume scales with mailbox count, not plan tier — the sequencer is a flat $99/mo with unlimited sending, and [mailboxes](/mailboxes) run $1.50-3.50 each:

| Setup | Monthly volume | Expected replies (at 6%) | Expected meetings |
|---------------|---------------:|--------------------------:|------------------:|
| 5 mailboxes (~$10/mo) | ~3,000 sends | ~180 replies | 40-70 |
| 15 mailboxes (~$25-55/mo) | ~9,000 sends | ~540 replies | 120-200 |
| 50 mailboxes (~$75-175/mo) | ~30,000 sends | ~1,800 replies | 400-700 |

These numbers assume signal-qualified targeting and signal-led personalization. Generic blasts will produce 60-70% less.
...
Every timeline above assumes one thing: your emails actually reach inboxes. That's why SendEmAll's guarantee targets the input, not the output — under 3% bounce on the leads we provide, or we refund your first month.

Why bounces and not replies? Because bounces are the one variable we fully control. Every lead we deliver is verified before you pay for it, so a bad list can never burn your domain during the critical warmup weeks — the single most common reason cold email timelines fall apart.

Replies depend on your offer and your copy. Deliverability depends on us. We guarantee our half.

[See pricing with the bounce guarantee →](/pricing)
...
**Signal-led personalization.** Emails that open with the signal that qualified the prospect get several times the reply rate of generic templates. Each one reads like a warm email instead of a cold one.
...
The best time to start was 90 days ago. The second best time is today. Create your account and begin the ramp.
