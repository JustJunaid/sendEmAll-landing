...
**Check:** Is this mailbox past the [Smart Ramp-Up](/blog/smart-ramp-up-explained) period? Has it been sending for 14-21 days with gradually increasing volume?
...
**How to verify:**
- Run every address through an [email verification service](/solutions/email-verification)
...
- **Smart Ramp-Up** — automatic for new mailboxes
- **List verification** — built-in [6-layer verification](/solutions/email-verification)
