...
Examples:
- `$160 vs $600 for the same outbound stack`
- `15% reply rates on cold email`
- `under 3% bounce, guaranteed`
...
[Test signal-based subject lines](https://app.sendemall.com/register) against your current subjects.
