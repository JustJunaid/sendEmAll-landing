...
- **Weighted rotation:** Newer mailboxes get fewer sends during Smart Ramp-Up. A 90-day-old mailbox gets 50/day while a 14-day-old mailbox gets 15/day.
- **Domain-based rotation:** Spread sends across multiple domains, not just multiple mailboxes on one domain.

SendEmAll uses weighted, domain-based rotation by default. New mailboxes automatically get less volume during [Smart Ramp-Up](/blog/smart-ramp-up-explained), then gradually increase. You don't configure anything.
...
- **Smart Ramp-Up:** 2-3 weeks per new mailbox before it can send at full capacity
...
Or use [managed infrastructure](/solutions/email-infrastructure) where all of this is handled. SendEmAll's Pro plan includes 15 mailboxes, managed domains, automatic rotation, and Smart Ramp-Up for $149/mo.
