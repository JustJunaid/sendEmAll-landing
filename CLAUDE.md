...
- **Warmup mechanism (public story, verified in monorepo):** a managed **engagement network** (varied, business-like template threads with paired replies) **plus a gradual ramp of real sends** (~2.5→14→30/mailbox/day). Never claim we "skip fake conversations" or attack pool-based warmup wholesale — that contradicts our own product; the honest frame is "engagement + real-send ramp, both halves."
